...
class TestControllerPipeline(test_base.TestCase):
    @mock.patch('fuxi_kubernetes.handlers.logging.LogExceptions')
    @mock.patch('fuxi_kubernetes.handlers.retry.Retry')
    ...
    @mock.patch('fuxi_kubernetes.handlers.logging.LogExceptions')
    @mock.patch('fuxi_kubernetes.handlers.asynchronous.Async')
